...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://formsubmit.co/ajax/t.rahul3105@gmail.com",
        {
          method: "POST",
          headers: {
  ...
  return (
    <section
      id="contact"
      className="py-20 px-6 max-w-7xl mx-auto transition-colors"
    >
      ...
      <p className="text-slate-600 dark:text-slate-400 text-center max-w-xl mx-auto mb-12">
        Have a project in mind, a backend development opportunity, or just want
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  href="mailto:t.rahul3105@gmail.com"
                  className="text-slate-800 dark:text-slate-200 hover:text-cyan-500 dark:hover:text-cyan-400 font-medium transition-colors"
                >
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 rounded-xl bg-cyan-500 text-slate-950 font-semibold flex items-center justify-center gap-2 hover:bg-cyan-400 transition-all shadow-lg shadow-cyan-500/10 cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed"
              >
